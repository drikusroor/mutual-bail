...
export default function BailPage() {
  ...
  // Panel ref for confetti sizing (MOVED UP)
  ...
  return (
    <div className="relative flex justify-center items-center min-h-screen">
      <div
        ref={panelRef}
        className="relative bg-white/20 backdrop-blur-lg p-6 md:p-8 rounded-xl shadow-2xl max-w-lg w-full text-center"
        style={{ minHeight: 400 }}
      >
        {showConfetti && (
          <ConfettiEffect width={panelSize.width} height={panelSize.height} style={{ left: 0, top: 0, zIndex: 10 }} />
        )}
